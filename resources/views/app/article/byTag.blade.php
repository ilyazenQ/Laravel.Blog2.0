@extends('layouts.app')
@section('seo')
<title>Здоровье и Лекарства - интересные и полезные материалы</title>
...
Портал Здоровье & Лекарства - актуальные статьи о фармацевтике, препаратах, методах лечения и профилактики.
Нужная информация в удобном формате.">
@endsection
@section('content')
